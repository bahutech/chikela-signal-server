...
/**
 * Chikela Tutoring - Room component
 *
 * @link    GitHub: https://github.com/bahutech/mirotalksfu
 * @link    Official Live demo: https://sfu.mirotalk.com
 * @license For open source use: AGPLv3
 * @license For commercial or closed source, contact us at license.mirotalk@gmail.com or purchase directly via bahutech
 * @license bahutech: https://bahutech.net/item/mirotalk-sfu-webrtc-realtime-video-conferences/40769970
 * @author  Bahu Man - hamlanbahar@gmail.com
 * @version 1.2.2
 *
 */
...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our Chikela Tutoring Video Chat Meeting`;
    ...
    Swal.fire({
        ...
        <div id="about">
            <button 
                ...
                class="pulsate" 
                onclick="window.open('https://bahutech.net/user/bahutech')">
            ...
            Email:<a 
                ...
                href="mailto:hamlanbahar@gmail.com?subject=Chikela Tutoring info"> 
                hamlanbahar@gmail.com
            </a>
        </div>
        `,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
